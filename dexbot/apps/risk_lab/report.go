/******************************************************************************
 * File Name       : report.go
 * File Path       : apps/risk_lab/report.go
 *
 ...
 *
 * Description     :
 *   Complete risk dashboard generator. Includes: ✅ Price chart ✅ Price table ✅ Returns table ✅ Statistics (Mean / Std / Var / MDD) ✅ Covariance heatmap ✅ Risk summary ✅ Portfolio (MPT baseline) ✅ Pie char
 *
 * Responsibilities:
